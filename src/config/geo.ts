...
export const UNDERSEA_CABLES: UnderseaCable[] = [
  ...
  },
  {
    ...
    landingPoints: [
      ...
      { country: 'PT', countryName: 'Portugal', city: 'S├úo Miguel', lat: 37.74, lon: -25.68 },
  ...
  },
  {
    ...
    owners: ['Google'],
    landingPoints: [
      { country: 'CL', countryName: 'Chile', city: 'Valpara├¡so', lat: -33.05, lon: -71.62 },
  ...
  // === ASIA-EUROPE ===
  {
    ...
    landingPoints: [
      ...
      { country: 'BD', countryName: 'Bangladesh', city: 'CoxΓÇÖs Bazar', lat: 21.43, lon: 91.99 },
  ...
  },
  {
    ...
    landingPoints: [
      ...
      { country: 'CN', countryName: 'China', city: 'Cape DΓÇÖAguilar', lat: 22.21, lon: 114.26 },
      { country: 'DJ', countryName: 'Djibouti', city: 'Djibouti City', lat: 11.59, lon: 43.15 },
      { country: 'EG', countryName: 'Egypt', city: 'Abu Talat', lat: 31.07, lon: 29.7 },
      { country: 'EG', countryName: 'Egypt', city: 'Zafarana', lat: 29.12, lon: 32.65 },
      { country: 'FR', countryName: 'France', city: 'Marseille', lat: 43.29, lon: 5.37 },
  ...
  // === AFRICA ===
  {
    ...
    landingPoints: [
      ...
      { country: 'CI', countryName: 'C├┤te d\'Ivoire', city: 'Abidjan', lat: 5.32, lon: -4.03 },
      { country: 'DJ', countryName: 'Djibouti', city: 'Djibouti City', lat: 11.59, lon: 43.15 },
      { country: 'EG', countryName: 'Egypt', city: 'Port Said', lat: 31.26, lon: 32.28 },
      { country: 'EG', countryName: 'Egypt', city: 'Ras Ghareb', lat: 28.37, lon: 33.08 },
      { country: 'EG', countryName: 'Egypt', city: 'Suez', lat: 29.97, lon: 32.53 },
  ...
  },
  {
    ...
    major: true,
    rfsYear: 2012,
    owners: ['Bayobab', 'Cable Consortium of Liberia', 'Canalink', 'Dolphin Telecom', 'GUILAB', 'Gambia Submarine Cable Company', 'International Mauritania Telecom', 'Orange', 'Orange Cameroun', 'Orange Cote dΓÇÖIvoire', 'Orange Mali', 'Republic of Cameroon', 'Republic of Equatorial Guinea', 'Republic of Gabon', 'Republic of Guinea Bissau', 'SBIN (Soci├⌐t├⌐ B├⌐ninoise des Infrastructures Num├⌐riques du B├⌐nin)', 'STP Cabo', 'Sierra Leone Cable Company', 'Sonatel', 'Zamani Telecom'],
    landingPoints: [
  ...
  },
  {
    ...
    major: true,
    rfsYear: 2002,
    owners: ['AT&T', 'Angola Telecom', 'BICS', 'Camtel', 'China Telecom', 'Chunghwa Telecom', 'Cogent', 'Ghana Telecommunications Company', 'KPN', 'Liquid Intelligent Technologies', 'Maroc Telecom', 'Mauritius Telecom', 'NATCOM (Nigeria)', 'OPT', 'Orange', 'Orange Cote dΓÇÖIvoire', 'PCCW', 'Singtel', 'Sonatel', 'Sparkle', 'Tata Communications', 'Telecom Namibia', 'Telefonica', 'Telekom Malaysia', 'Telkom South Africa', 'Telstra', 'Verizon', 'Vodafone'],
    landingPoints: [
      ...
      { country: 'RE', countryName: 'R├⌐union', city: 'Saint Paul', lat: -21, lon: 55.28 },
      { country: 'ZA', countryName: 'South Africa', city: 'Melkbosstrand', lat: -33.73, lon: 18.45 },
      { country: 'ZA', countryName: 'South Africa', city: 'Mtunzini', lat: -28.95, lon: 31.76 },
    ],
    countriesServed: [
  ...
  },
  {
    ...
    major: true,
    rfsYear: 2002,
    owners: ['AT&T', 'Altice Portugal', 'Angola Telecom', 'BICS', 'BT', 'Camtel', 'China Telecom', 'Chunghwa Telecom', 'Cogent', 'Cyta', 'Deutsche Telekom', 'Ghana Telecommunications Company', 'KPN', 'KT', 'Liquid Intelligent Technologies', 'Maroc Telecom', 'Mauritius Telecom', 'NATCOM (Nigeria)', 'OPT', 'Orange', 'Orange Cote dΓÇÖIvoire', 'PCCW', 'SBIN (La Soci├⌐t├⌐ B├⌐ninoise dΓÇÖInfrastructures Num├⌐riques)', 'Singtel', 'Sparkle', 'Tata Communications', 'Telecom Namibia', 'Telekom Malaysia', 'Telkom South Africa', 'Telstra', 'Telxius', 'Verizon', 'Vodafone'],
    landingPoints: [
  ...
  },
  {
    ...
    landingPoints: [
      ...
      { country: 'RE', countryName: 'R├⌐union', city: 'Sainte Marie', lat: -20.9, lon: 55.55 },
    ],
    countriesServed: [
  ...
  },
  {
    ...
    landingPoints: [
      ...
      { country: 'CW', countryName: 'Cura├ºao', city: 'Willemstad', lat: 12.1, lon: -68.9 },
      ...
      { country: 'MX', countryName: 'Mexico', city: 'Canc├║n', lat: 21.1, lon: -86.77 },
  ...
  },
  {
    ...
    owners: ['V.tal'],
    landingPoints: [
      { country: 'BM', countryName: 'Bermuda', city: 'St. DavidΓÇÖs', lat: 32.31, lon: -64.77 },
      { country: 'BR', countryName: 'Brazil', city: 'Fortaleza', lat: -3.72, lon: -38.54 },
      { country: 'BR', countryName: 'Brazil', city: 'Rio de Janeiro', lat: -22.9, lon: -43.21 },
      { country: 'CO', countryName: 'Colombia', city: 'Barranquilla', lat: 10.94, lon: -74.78 },
      { country: 'US', countryName: 'United States', city: 'Boca Raton', lat: 26.35, lon: -80.09 },
  ...
  },
  {
    ...
    major: true,
    rfsYear: 2019,
    owners: ['AustraliaΓÇÖs Academic and Research Network (AARNET)', 'Google', 'Indosat Ooredoo', 'Singtel', 'Superloop', 'Telstra'],
    landingPoints: [
  ...
  },
  {
    ...
    major: true,
    rfsYear: 2020,
    owners: ['AustraliaΓÇÖs Academic and Research Network (AARNET)', 'Google', 'Lightstorm Telecom'],
    landingPoints: [
      { country: 'AU', countryName: 'Australia', city: 'Brookvale', lat: -33.76, lon: 151.27 },
  ...
  },
  {
    ...
    landingPoints: [
      ...
      { country: 'PL', countryName: 'Poland', city: 'Ko┼éobrzeg', lat: 54.17, lon: 15.57 },
