// Dynamic Meta Tags Service for C⁴ Monitoring Dashboard
...
export function updateMetaTagsForStory(meta: StoryMeta): void {
  ...
  const title = `${countryName} Intelligence Brief | C⁴ Monitoring Dashboard`;
...
export function resetMetaTags(): void {
  const defaultTitle = 'C⁴ Monitoring Dashboard - Global Situation with AI Insights';
...
function generateDescription(
  ...
  return `C⁴ Monitoring Dashboard ${parts.join('. ')}. Free, open-source geopolitical intelligence.`;
}
