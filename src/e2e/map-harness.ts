...
const allLayersEnabled: MapLayers = {
  ...
  weatherRadar: true,
  gpsJamming: true,
  agriculturalStressDI: true, agriculturalStressASI: true, agriculturalStressVCI: true,
  economic: true,
  waterways: true,
  outages: true,
  cyberThreats: true,
...
const allLayersDisabled: MapLayers = {
  ...
  weatherRadar: false,
  gpsJamming: false,
  agriculturalStressDI: false, agriculturalStressASI: false, agriculturalStressVCI: false,
  economic: false,
  waterways: false,
  outages: false,
  cyberThreats: false,
